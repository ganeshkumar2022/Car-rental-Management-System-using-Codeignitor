...
<div class="container-fluid">
 <h3 class="font-weight-normal pt-4">Manage Testimonials</h3>
<div class="row">
        ...
        ?>
            <tr>
                ...
                <td>
                    ...
                    {
                        ?>
                        <button onclick="confirm(<?=$row->tid?>)" class="text-decoration-none btn-sm btn btn-link">Inactive</button>    
                        <?php
                    }
                    else
                    {
                        echo '
                        <button class="text-decoration-none btn-sm btn btn-link">'.$row->status.'</button>    
                        ';
                    }
                    ?>
                </td>
...
<script type="text/javascript">
 ...
 function confirm(x)
 {
    window.location.replace("http://localhost/car_rental/admin/manageTestimonial?eid="+x);
 }
</script>
    </div>
</div>
